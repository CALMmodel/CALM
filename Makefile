...
HSRC_EVENTS = Parser.cxx Configurator.cxx ParticleDB.cxx ParticleType.cxx EventGenerator.cxx Event.cxx Particle.cxx ParticleCoor.cxx Crc32.cxx Vector3D.cxx CALM.cxx
